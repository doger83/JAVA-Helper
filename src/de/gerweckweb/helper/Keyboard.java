...
public final class Keyboard {
    ...
    public static double readDouble(String promptMsg, String errorMsg, double low, double high) {
        return printValueAfterCheckForValid(promptMsg, errorMsg, low, high);
    }
    ...
    public static double readDouble(String promptMsg, String errorMsg) {
        return printValueAfterCheckForValid(promptMsg, errorMsg, Double.MIN_VALUE, Double.MAX_VALUE);
    }
     ...
     * @author daniel neubieser
     */
    public static double readDoubleFromGui(JTextField textField, double min, double max) {
        //check for keyword
        tryKeyword(textField.getText().toUpperCase());
        // keep looking until valid userinput
     ...
     * @author domininic gerweck/daniel neubieser
     */
    private static double printValueAfterCheckForValid(String promptMsg, String errorMsg, double low, double high) {
        double num = 0;
        boolean isValid = false;
        // keep looking until valid userinput
        while (!isValid) {
